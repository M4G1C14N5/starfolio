...
pandoc "$SCRIPT_DIR/public/Thomas_Tsangou_Resume.md" \
  ...
  -V "header-includes=\\usepackage{setspace}\\setstretch{0.9}\\usepackage{enumitem}\\setlist[itemize]{noitemsep,topsep=1pt,parsep=0pt,partopsep=0pt,leftmargin=*}\\setlist[enumerate]{noitemsep,topsep=1pt,leftmargin=*}\\def\\tightlist{}" \
